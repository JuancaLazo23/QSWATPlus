...
try:
    ...
    print("⚠️ Módulo 'processing' no está disponible. Algunas funciones se desactivarán.")
...
#         """)
    ...
    def setupProject(self, proj, isBatch, isHUC=False, isHAWQS=False, logFile=None):
        ...
        if 'processing_available' in globals() and processing_available:
            Processing.initialize()
        else:
            print("⚠️ 'Processing' no está disponible: se omite su inicialización.")
